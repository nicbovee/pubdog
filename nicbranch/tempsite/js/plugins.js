...
$(document).ready(function(){
	...
	/* googleMaps Footer Map */
		...
		var latlng = new google.maps.LatLng(38.840399,-104.862973); <!-- (Fist Value Longitude, Second Value Latitude), can obtain YOUR coordenates here!: http://universimmedia.pagesperso-orange.fr/geo/loc.htm -->
		var styles = [
			{
		...
		var point0 = new google.maps.LatLng(38.840399,-104.862973); <!-- (Fist Value Longitude, Second Value Latitude), can obtain YOUR coordenates here!: http://universimmedia.pagesperso-orange.fr/geo/loc.htm -->
